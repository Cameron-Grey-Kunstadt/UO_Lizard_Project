...
OUTPUT_FILE="nano_v5_12_03"
OUTPUT_DIR="/projects/bgmp/shared/groups/2024/lizards/shared/full_np_output_no_trim/"
...
#/usr/bin/time -v python filter_by_readsize.py -f $POLY_FILE \
#     -o $LEN_FILE\
#     -l $MIN_READ_SIZE \
#     -u $MAX_READ_SIZE
